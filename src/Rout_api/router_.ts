...
import { So2_SaveApi, Choho_SaveApi, No2_SaveApi, Show_data_Ges, Location_Ges_Time} from "../API_Meteorological_/Gas_data_"
...
import { Save_Station_Weather, Save_3Hours_weather_, Location_Ges_SAVE, showData_Air4Thai, ShowData_Weather_, V, P ,Station_Length, Data_Whather_Now, Show_stationAll_Now, Time_Air4, } from "../API_Meteorological_/Weather_"
...
rou.get('/V', P)
rou.get('/airtiemisan/:year/:month/:day', Time_Air4)
...
rou.get('/gestime/:year/:month/:day/:hours/:id', Location_Ges_Time)
